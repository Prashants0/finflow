...
-- CreateTable
CREATE TABLE "public"."bse_symbol" (
    ...
    CONSTRAINT "bse_symbol_pkey" PRIMARY KEY ("symbol_Id")
);
...
CREATE TABLE "public"."Watchlists" (
    ...
    "name" TEXT NOT NULL,
    "num_of_symbols" INTEGER NOT NULL DEFAULT 0,
...
-- AddForeignKey
ALTER TABLE "public"."Watchlists" ADD CONSTRAINT "Watchlists_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Watchlist_items" ADD CONSTRAINT "Watchlist_items_symbol_fkey" FOREIGN KEY ("symbol") REFERENCES "public"."bse_symbol"("symbol_Id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Watchlist_items" ADD CONSTRAINT "Watchlist_items_watchlist_id_fkey" FOREIGN KEY ("watchlist_id") REFERENCES "public"."Watchlists"("watchlist_id") ON DELETE RESTRICT ON UPDATE CASCADE;
